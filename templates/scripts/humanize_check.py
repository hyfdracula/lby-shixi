#!/usr/bin/env python3
"""Validate lby-shixi humanize_matrix.md and scan report_draft.md for remaining AI patterns."""
...
# --- self-contained table helpers (no _lby_utils import) ---
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate lby-shixi humanize_matrix.md")
...
def main() -> int:
    ...
    lang = "zh"
    config_path = out_dir / "lby_config.json"
    ...
    manuscript_text = ""
    draft_path = out_dir / "report_draft.md"
    if draft_path.exists():
        manuscript_text = draft_path.read_text(encoding="utf-8", errors="ignore")
