...
from _lby_utils import table_rows

USER_AGENT = "lby-shixi/3.0 (citation-zh; https://github.com/WUBING2023/lby-shixi)"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Verify Chinese citations for lby-shixi.")
